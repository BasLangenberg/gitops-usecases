...
## curl https://raw.githubusercontent.com/kubernetes/ingress-nginx/main/deploy/static/provider/do/deploy.yaml | tfk8s --strip >> nginx.tf
  ...
  manifest = {
    ...
    "metadata" = {
      "annotations" = {
        ...
        "service.beta.kubernetes.io/do-loadbalancer-name" = "lb-mgmt"
      }
      "labels" = {
        "app.kubernetes.io/component" = "controller"
        "app.kubernetes.io/instance" = "ingress-nginx"
